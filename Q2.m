clc; clear;
% This program is developed by  Soheil Hekmat respect to Question2
...
% B is a 12*4 matrix. each row is start and end coordinates of one side 
% of a polygone which is a simply a line. line 7 is for the square line 8
% for triangle and line 9 for pentagone
